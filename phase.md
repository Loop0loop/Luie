...
- Phase 6-2 canonical memory payload schema version compatibility의 legacy/missing-version 허용과 future-version 거부는 1차 완료되어 있다.
...
- 현재는 **Phase 6-2 migration compatibility 일부 완료 상태**다.
