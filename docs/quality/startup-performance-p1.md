...
> 2026-09-10 검토 후: 아래 테스트·실측은 과거 이력이며 현재 승인 근거로 재사용하지 않는다. 벤치마크의 timeout 오판정 수정과 새 테스트의 범위·결과는 [판정 오류 수정 기록](startup-benchmark-outcome-review-2026-09-10.md)에 구분했다. 실제 제품·성능의 최종 수용은 사용자 검토 대기다.
