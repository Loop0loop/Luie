...
export const LABEL_ANALYSIS_TITLE = '원고 분석'
export const LABEL_ANALYSIS_SELECT_CHAPTER = '분석할 챕터 선택'
export const LABEL_ANALYSIS_START_BUTTON = '분석 시작'
export const LABEL_ANALYSIS_ANALYZING = '분석 중...'
export const LABEL_ANALYSIS_EMPTY_STATE = '챕터를 선택하고 분석을 시작하세요.\nAI가 독자의 시선으로 원고를 분석합니다.'
export const LABEL_ANALYSIS_RESULT_REACTION = '독자 반응'
export const LABEL_ANALYSIS_RESULT_CONTRADICTION = '모순점 발견'
export const LABEL_ANALYSIS_RESULT_EMPTY = '분석 결과가 없습니다.'
