...
export const ErrorCode = {
  ...
  LUIE_LEGACY_FORMAT_UNSUPPORTED: 'FS_2005',
  ...
  RAG_QA_FAILED: 'RAG_QA_FAILED',
  RAG_QA_ABORTED: 'RAG_QA_ABORTED',
  RAG_QA_UTILITY_EXITED: 'RAG_QA_UTILITY_EXITED',
  ...
  // Event Errors (98xx)
  EVENT_NOT_FOUND: 'EVT_9801',
  EVENT_CREATE_FAILED: 'EVT_9802',
  EVENT_DELETE_FAILED: 'EVT_9803',
  EVENT_UPDATE_FAILED: 'EVT_9804',

  // Faction Errors (99xx)
  FACTION_NOT_FOUND: 'FAC_9901',
  FACTION_CREATE_FAILED: 'FAC_9902',
  FACTION_DELETE_FAILED: 'FAC_9903',
  FACTION_UPDATE_FAILED: 'FAC_9904',

  // Scene Errors (100xx)
  SCENE_NOT_FOUND: 'SCN_10001',
  SCENE_CREATE_FAILED: 'SCN_10002',
  SCENE_DELETE_FAILED: 'SCN_10003',
  SCENE_UPDATE_FAILED: 'SCN_10004',

  // Note Errors (101xx)
  NOTE_NOT_FOUND: 'NOT_10101',
  NOTE_CREATE_FAILED: 'NOT_10102',
  NOTE_DELETE_FAILED: 'NOT_10103',
  NOTE_UPDATE_FAILED: 'NOT_10104',

  // Synopsis Errors (102xx)
  SYNOPSIS_NOT_FOUND: 'SYN_10201',
  SYNOPSIS_CREATE_FAILED: 'SYN_10202',
  SYNOPSIS_DELETE_FAILED: 'SYN_10203',
  SYNOPSIS_UPDATE_FAILED: 'SYN_10204',

  // Plot Errors (103xx)
  PLOT_NOT_FOUND: 'PLT_10301',
  PLOT_CREATE_FAILED: 'PLT_10302',
  PLOT_DELETE_FAILED: 'PLT_10303',
  PLOT_UPDATE_FAILED: 'PLT_10304',

  // Scrap memo Errors (104xx)
  SCRAP_MEMO_NOT_FOUND: 'SCR_10401',
  SCRAP_MEMO_CREATE_FAILED: 'SCR_10402',
  SCRAP_MEMO_DELETE_FAILED: 'SCR_10403',
  SCRAP_MEMO_UPDATE_FAILED: 'SCR_10404',
} as const
