...
export const LAYOUT_SURFACE_CONFIG: Record<LayoutSurfaceId, LayoutSurfaceConfig> = {
  ...
  "docs.panel.character": { ...DEFAULT_PANEL_CONFIG },
  "docs.panel.event": { ...DEFAULT_PANEL_CONFIG },
  "docs.panel.faction": { ...DEFAULT_PANEL_CONFIG },
  "docs.panel.world": { ...DEFAULT_PANEL_CONFIG },
  "docs.panel.scrap": { ...DEFAULT_PANEL_CONFIG },
  "docs.panel.analysis": { ...DEFAULT_PANEL_CONFIG },
  "docs.panel.snapshot": { ...DEFAULT_PANEL_CONFIG, defaultRatio: 26 },
  "docs.panel.trash": { ...DEFAULT_PANEL_CONFIG, defaultRatio: 26 },
  "docs.panel.editor": { ...DEFAULT_PANEL_CONFIG, defaultRatio: 30 },
  "docs.panel.export": { ...DEFAULT_PANEL_CONFIG, defaultRatio: 30 },
  "editor.panel.character": { ...DEFAULT_PANEL_CONFIG },
  "editor.panel.world": { ...DEFAULT_PANEL_CONFIG },
  "editor.panel.scrap": { ...DEFAULT_PANEL_CONFIG },
  "editor.panel.analysis": { ...DEFAULT_PANEL_CONFIG },
