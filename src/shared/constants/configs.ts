...
export const SNAPSHOT_MAX_COUNT = 200 // Maximum number of snapshots per project
export const SNAPSHOT_INTERVAL_MS = 60 * 1000
export const SNAPSHOT_KEEP_COUNT = 200
export const SNAPSHOT_FILE_KEEP_COUNT = 120
export const DEFAULT_PROJECT_SNAPSHOT_KEEP_COUNT = 50
export const SNAPSHOT_MIN_CONTENT_LENGTH = 1
export const SNAPSHOT_MIN_CHANGE_RATIO = 0.01
export const SNAPSHOT_MIN_CHANGE_ABSOLUTE = 1
