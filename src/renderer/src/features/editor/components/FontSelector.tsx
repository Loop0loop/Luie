...
export function FontSelector() {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        className="flex items-center gap-1 px-2 h-8 rounded bg-app border border-border text-fg text-xs cursor-pointer hover:bg-hover w-24 justify-between shadow-sm"
