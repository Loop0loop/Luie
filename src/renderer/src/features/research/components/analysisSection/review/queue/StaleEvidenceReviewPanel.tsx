    ...
    <div className="rounded-panel border border-border/40 bg-surface/40 dark:bg-surface/20 backdrop-blur-md px-3.5 py-2.5 text-xs shadow-sm">
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          onClick={onRepair}
          disabled={repairing}
          className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-border/40 text-muted hover:border-accent/30 hover:bg-accent/10 disabled:opacity-50 transition-[colors,transform] duration-150 active:scale-90"
                ...
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="shrink-0 flex gap-1">
                    <button
                      ...
                      className="inline-flex h-7 w-7 items-center justify-center rounded-full border border-border/40 text-muted hover:border-warning/30 hover:bg-warning/10 disabled:opacity-50 transition-[colors,transform] duration-150 active:scale-90"
