...
import FocusHoverSidebar from "./FocusHoverSidebar";

const ResearchPanel = React.lazy(() => import("../research/ResearchPanel"));
const WorldPanel = React.lazy(() => import("../research/WorldPanel"));
const SnapshotList = React.lazy(() => import("../snapshot/SnapshotList").then((m) => ({ default: m.SnapshotList })));
const TrashList = React.lazy(() => import("../trash/TrashList").then((m) => ({ default: m.TrashList })));
