  ...
  return (
    <div className="h-full flex flex-col select-none">
      ...
      {menuOpenId && (
        <div
          ref={menuRef}
          className="fixed z-[10000] bg-panel border border-border/40 rounded-lg shadow-lg min-w-[170px] p-1.5 animate-in fade-in zoom-in-95 duration-100 flex flex-col"
