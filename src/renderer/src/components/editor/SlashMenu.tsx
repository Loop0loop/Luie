...
const MENU_ITEMS = [
  { id: 'h1', label: '대제목', icon: <Heading1 size={18} />, description: '섹션의 큰 제목' },
  { id: 'h2', label: '중제목', icon: <Heading2 size={18} />, description: '섹션의 중간 제목' },
  { id: 'h3', label: '소제목', icon: <Heading3 size={18} />, description: '섹션의 작은 제목' },
