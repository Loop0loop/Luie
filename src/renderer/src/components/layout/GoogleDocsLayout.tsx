    ...
    <div className="flex flex-col h-screen bg-background text-foreground font-sans transition-colors duration-200">
      ...
      <div className="flex-1 flex flex-row overflow-hidden relative">
        <PanelGroup orientation="horizontal" className="flex w-full h-full flex-1 overflow-hidden relative" id="google-docs-layout">
          ...
          {isSidebarOpen && (
            <>
              <Panel id="left-sidebar" defaultSize={20} minSize={15} maxSize={40} className="bg-background border-r border-border overflow-hidden flex flex-col shrink-0 min-w-0">
                {sidebar}
              </Panel>
          ...
          <Panel id="center-content" minSize={30} className="flex-1 flex flex-col min-w-0 bg-secondary/30 relative z-0 transition-colors duration-200">
            <div className="flex-1 relative flex flex-col overflow-hidden">
              <PanelGroup orientation="horizontal" className="flex w-full h-full flex-1 overflow-hidden relative" id="google-docs-split-editor">
                <Panel id="editor-main-panel" defaultSize={100} minSize={20} className="min-w-0 bg-transparent relative flex flex-col">
                  <EditorDropZones />
          ...
          {activeRightTab && (
            <>
              ...
              <Panel id="right-context-panel" defaultSize={25} minSize={15} maxSize={40} className="bg-background border-l border-border overflow-hidden flex flex-col shrink-0 min-w-0">
