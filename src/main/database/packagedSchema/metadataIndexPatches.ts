...
export const PACKAGED_SCHEMA_INDEX_PATCHES: ReadonlyArray<IndexPatch> = [
  {
    name: "SearchDirtyQueue_runnable_idx",
    table: "SearchDirtyQueue",
    sql: 'CREATE INDEX IF NOT EXISTS "SearchDirtyQueue_runnable_idx" ON "SearchDirtyQueue"("status", "attempts", "updatedAt");',
  },
  {
    name: "MemoryBuildJob_runnable_idx",
