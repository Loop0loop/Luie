export const HWPX_VERSION_XML = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
export const HWPX_MANIFEST_XML = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<odf:manifest xmlns:odf="urn:oasis:names:tc:opendocument:xmlns:manifest:1.0"/>`;

export const HWPX_CONTAINER_XML = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
export const HWPX_CONTAINER_RDF_XML = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
export const HWPX_SETTINGS_XML = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
