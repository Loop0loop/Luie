# Luie
![Luie](./assets/portfolio/feature/hero.png)
...
![Tiptap](https://img.shields.io/badge/Tiptap-000000?logo=probot&logoColor=white)
...
<table align="center">
  ...
  <tr>
    <td width="250" align="center">
      <img src="./assets/portfolio/teams/imsehun.png" width="180"/><br/><br/>
      <strong>
        <a href="https://github.com/ummsehun">임세훈</a>
      </strong><br/><br/>
      Electron App 구성<br/>
...
![World Graph](./assets/portfolio/feature/graph.png)
...
![Snapshot Recovery](./assets/portfolio/feature/recovery.png)
...
![Export Preview](./assets/portfolio/feature/export.png)
...
- Default Mode : 기본 모드
![Layout Modes](./assets/portfolio/layout/default.png)
- Editor Mode : 에디터 모드
![Layout Modes](./assets/portfolio/layout/editors.png)
- Google Docs Style : 구글 독스 스타일
![Layout Modes](./assets/portfolio/layout/googledocs.png)
- Scrivener Style : 스크리브너 스타일
![Layout Modes](./assets/portfolio/layout/scriv.png)
---

# Architecture
![Architecture](./assets/portfolio//architecture/architecture.png)
...
![Template Select](./assets/portfolio/feature/template.png)

## AI Analysis 
![AI Analysis](./assets/portfolio/sanp/Analysis.png)

## Character
![Character](./assets/portfolio/sanp/Character.png)
